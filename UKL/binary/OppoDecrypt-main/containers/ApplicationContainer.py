...
class ApplicationContainer(containers.DeclarativeContainer):
    ...
    logging = providers.Singleton(LoguruLoggingService, configuration=configuration.log)
        ...
        extractors=providers.Dict(
            {
                ...
                "sparse": providers.Factory(SparseExtractor, logger=logging),
                "super": providers.Factory(SuperImgExtractor, logger=logging),
            }
        ),
        logger=logging,
    )
